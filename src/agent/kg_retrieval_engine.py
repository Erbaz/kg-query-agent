...
class KGRetrievalEngine:    
    def __init__(self, llm, sub_retrievers=None ):
        
        self.graph_store = MemgraphPropertyGraphStore(
            url="bolt://localhost:7687", username="memgraph", password=""
        )
        ...
        ] if sub_retrievers is None else sub_retrievers
        ...
        self.graph_tool = QueryEngineTool.from_defaults(
            ...
            description="Query the Memgraph knowledge graph.",
        )
