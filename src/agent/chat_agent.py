...
class ChatAgent:
    def __init__(
        ...
        self.llm = self.init_llm(api_key, model_name=llm_model)
        self.db_url = db_url
        ...
        self.query_engine_tools = (
            [self.kg_engine.graph_tool] if tools is None else tools
        )
    ...
    @staticmethod
    def init_llm(api_key, model_name: Optional[str] = None):
